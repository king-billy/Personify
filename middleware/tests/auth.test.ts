...
describe("Auth Routes", () => {
	...
	it(`POST /auth/refresh with missing body should return 400 — missing "refresh_token"`, async () => {
	...
	it("POST /auth/refresh with mocked data should return 500 — invalid refresh_token", async () => {
